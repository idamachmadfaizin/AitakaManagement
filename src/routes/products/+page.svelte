<script lang="ts">
	...
	import CubeIcon from '../../components/icons/heroicons/CubeIcon.svelte';
</script>

<div
	class="flex flex-col p-4 text-gray-500 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700 sm:p-6"
>
	...
	<Table divClass="mt-3" hoverable={true}>
		<TableHead>
